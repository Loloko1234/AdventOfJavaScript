    ...
    <div className="content">
      ...
      <main>
        ...
        <p>
          ...
          playing around. Now it's about building things.” — Frankly, I'm not
          sure why “playing around” and “building things” have to be mutually
          exclusive.
        </p>
        ...
        <p>
          ...
          and, “Imagine this. The user will scroll down, and this will happen…”
        </p>
        ...
        <div className="image-text-wrapper">
          ...
          <div className="image-text-wrapper__content">
            <p>
              In November (2020), I started working with a new client, designing
              a native application. About the same time, I was listening to the{" "}
              <a
        ...
        <h3 id="Enter-Framer">Enter Framer</h3>
        ...
        <h3 id="For-the-no-coders-Framer-is-for-you">
        ...
        <h3 id="For-the-code-saavy-Framer-is-for-you">
        ...
        <h3 id="My-Sweet-Spot-How-Our-Team-is-Using-Framer">
        ...
        <h3 id="My-Framer-Desktop">Framer Desktop</h3>
        ...
        <p>
          ...
          the user is in Phase 1 vs. Phase 3 of the program? Instead of creating
          prototypes for each use case, I update the data passed in.
        </p>
        ...
        <h3 id="Tight-Developer-Schedule">Tight Developer Schedule</h3>
